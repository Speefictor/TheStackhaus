      ...
      <div className="container mx-auto py-12 px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="md:col-span-1 lg:col-span-1">
            <h3 className="text-2xl font-bold font-headline text-primary mb-4">GourmondoClone</h3>
            <p className="text-sm max-w-xs">Artisanal catering for unforgettable moments. We bring creativity and flavor to every event.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <address className="text-sm not-italic space-y-2">
              ...
              <p>
                <a href="mailto:contact@gourmondoclone.com" className="hover:text-primary transition-colors">contact@gourmondoclone.com</a>
              </p>
               <p>
        ...
        <div className="mt-8 pt-8 border-t border-border/50 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} GourmondoClone. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
